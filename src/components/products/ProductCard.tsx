      ...
      >
        ...
        {hasSecondaryImage && (
          <img
            ...
            className="absolute inset-0 h-full w-full object-contain p-4 opacity-0 scale-110 transition-all duration-500 group-hover:opacity-100 group-hover:scale-100"
          />
        )}
