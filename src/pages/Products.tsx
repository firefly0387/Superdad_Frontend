...
const Products = () => {
  ...
  const maxPriceFromUrl = searchParams.get("maxPrice") ? Number(searchParams.get("maxPrice")) : 50000;
  ...
  }, [categoryId, subcategoryId, debouncedSearch, ordering, minPrice, maxPrice, hotDeals]);
  ...
  const updateURL = (updates: { category?: string; subcategory?: string; hotDeals?: boolean; maxPrice?: number }) => {
  ...
  const activeFilters =
    categoryId !== "" || subcategoryId !== "" || minPrice !== "" || maxPrice !== "" || hotDeals || search !== "" || ordering !== "";
