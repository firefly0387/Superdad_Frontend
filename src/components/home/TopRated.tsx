...
import { Star, ShoppingCart, TrendingUp, Sparkles, ChevronLeft, ChevronRight } from "lucide-react";
                ...
                <div className="relative mb-4 overflow-hidden rounded-2xl bg-[#D4C4A8]/20 aspect-square">
                  ...
                  {item.average_rating && (
                    <div className="absolute top-3 left-3 flex items-center gap-1 bg-white/80 backdrop-blur-sm px-2 py-1 rounded-full z-10">
                      ...
                      <span className="text-xs text-[#5C3D2E] font-medium">
              ...
              <div className="cursor-pointer" onClick={() => navigate(`/products/${topRated[currentIndex].id}`)}>
                <div className="relative mb-4 overflow-hidden rounded-2xl bg-[#D4C4A8]/20 aspect-square">
                  <img
                    ...
                    alt={topRated[currentIndex].title}
                  ...
                  {topRated[currentIndex].average_rating && (
                    <div className="absolute top-3 left-3 flex items-center gap-1 bg-white/80 backdrop-blur-sm px-2 py-1 rounded-full z-10">
                      <Star size={12} fill="#fbbf24" className="text-amber-400" />
                      <span className="text-xs text-[#5C3D2E] font-medium">
                        {topRated[currentIndex].average_rating.toFixed(1)}
                      </span>
                    </div>
                  )}
                  ...
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
                      handleAddToCart(topRated[currentIndex], e);
                    }}
                ...
                <div>
                  ...
                  <div className="flex items-baseline gap-2">
                    ...
                    {topRated[currentIndex].discount_per && (
                      <span className="text-sm text-[#8B6914]/50 line-through">
                        Rs {Number(topRated[currentIndex].price).toLocaleString()}
                      </span>
                    )}
                  </div>
                </div>
